/**
 * Project Manager - Add New Project Page
  ...
  return (
    <div className="p-6">
      <div className="mb-6">
        ...
        <p className="text-gray-600">Create a new project and assign contractors</p>
      </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div>
                  ...
                  <select className="w-full p-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500">
                    ...
                    <option value="agri-projects">Agri Projects Co</option>
                  </select>
                </div>
              </div>
