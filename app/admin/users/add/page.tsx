  ...
  return (
    <div className="p-6">
      <div className="mb-6">
        ...
        <p className="text-gray-600">Create a new user account with appropriate role and permissions</p>
      </div>
            ...
            <form className="space-y-6">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div>
                  ...
                  <select className="w-full p-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500">
                    ...
                    <option value="nigerian-ports-authority">Nigerian Ports Authority</option>
                    <option value="civil-service-commission">Federal Civil Service Commission</option>
                  </select>
                </div>
              </div>
              ...
              <div>
                ...
                <div className="space-y-2">
                  <label className="flex items-center">
                    ...
                    <span className="text-sm text-gray-700">Active - User can log in and use the system</span>
                  </label>
                  <label className="flex items-center">
                    <input type="radio" name="status" value="inactive" className="mr-2" />
                    <span className="text-sm text-gray-700">Inactive - User cannot log in</span>
                  </label>
                </div>
              </div>
              ...
              <div>
                ...
                <div className="grid grid-cols-2 md:grid-cols-3 gap-4">
                  ...
                  <label className="flex items-center">
                    <input type="checkbox" className="mr-2" />
                    <span className="text-sm text-gray-700">Manage Reports</span>
                  </label>
                  <label className="flex items-center">
                    <input type="checkbox" className="mr-2" />
